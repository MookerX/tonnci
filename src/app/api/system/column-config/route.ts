...
const DEFAULT_COLUMNS = [
  ...
  { key: 'materialName', label: '名称', width: 120, visible: true, order: 2 },
  { key: 'drawingCode', label: '图纸编码', width: 120, visible: true, order: 3 },
  { key: 'drawingNo', label: '图号', width: 130, visible: true, order: 4 },
  { key: 'materialType', label: '物料类型', width: 60, visible: true, order: 5 },
  { key: 'quantity', label: '单层用量', width: 60, visible: true, order: 6 },
  { key: 'customerGroupName', label: '所属客户', width: 60, visible: true, order: 7 },
  { key: 'remark', label: '备注', width: 172, visible: true, order: 8 },
  { key: 'bomCreatorName', label: 'BOM创建者', width: 84, visible: false, order: 9 },
  { key: 'bomCreatedAt', label: 'BOM创建时间', width: 110, visible: true, order: 10 },
  { key: 'materialCreatorName', label: '物料创建者', width: 90, visible: false, order: 11 },
  { key: 'materialCreatedAt', label: '物料创建时间', width: 110, visible: true, order: 12 },
  { key: 'bomUpdatedAt', label: 'BOM修改时间', width: 140, visible: false, order: 13 },
  { key: 'materialModifierName', label: '物料修改者', width: 90, visible: false, order: 14 },
  { key: 'materialUpdatedAt', label: '物料修改时间', width: 140, visible: false, order: 15 },
  { key: 'bomModifierName', label: 'BOM修改者', width: 64, visible: false, order: 16 },
  { key: 'actions', label: '操作', width: 130, visible: true, order: 17 },
];
