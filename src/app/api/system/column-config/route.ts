...
const DEFAULT_COLUMNS = [
  ...
  { key: 'quantity', label: '用量', width: 70, visible: true, order: 5 },
  { key: 'materialType', label: '类型', width: 80, visible: true, order: 6 },
  { key: 'customerGroupName', label: '客户', width: 100, visible: true, order: 7 },
